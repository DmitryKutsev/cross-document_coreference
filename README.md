...
Самая базовая версия алгорится неожидонно показала неплохой результат:
md``` 
0.6392405063291139  presicion
0.6688741721854304  recall
0.6537216828478964  f-score```

Это можно использовать в качестве бейзлайна, и такой результат сопоставим с резульатами, описанными в исследованиях аналогичных методов.
