...
Внутри форумов были выбраны подфорумы. "Вопросы по препаратам" для hv-info, "Чем и как лечимся" для rakpobedim и "Психофармакотерапия: обсуждение препаратов, отзывы" для форума neuroleptic. Данные с форума mneploho.net не размечались, но были использованы в качестве обучения векторных представлений слов, ка к тематически близкие.

Форумы структурированы иерархично: каждый форум делится на подфорумы, подфорумы на топики, в каждом топике имеется определенное количество постов. Посты - это пользовательские сообщения по теме, которая прикрепляется в самом первом сообщении топика. Как правило, тема содержит название обсуждаемого препарата. Например, на форуме neuroleptic из 40 просмотренных топиков в 35 название препарата, обсуждаемого в теме, присутствовало в первом сообщении. Из оставшихся пяти назавания препаратов присутствовали в большинстве постов. Например, в теме "Посоветуйте активирующий нейролептик" ответами являются посты с назаваниями препаратов.

В зависимости от тематики, форумы более, или менее четко структурированны, например форум с обсуждениями препаратов против рака имеет менее четкую тематическую структуру, чем форум с обсуждениями нейролептиков.

Отдельно стоит отметить данные форума, посвященного препаратам против гепатита. В большинстве постов присутствует множество сленговых фраз и выражений, что само по себе может составлять отдельную тему для исследования. Ниже представлены примеры сленговых выражений и ихз расшифровки:
...
В обсуждениях нейролептриков и препаратов против рака тоже присутствует своя терминология, но она либо интуитивно понятна, либо представляет собой набор медицинских терминов.
