...
Лучшие резльтаты показывала модель K-nearest neighbours, со следующими метриками:
```md
...
``` 
Остальные модели справились хуже.

Правиловый бейзлайн перебить не удалось.
