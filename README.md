...
```md
  ...
  - NER - размеченное значение сущности. 1 - название препарата, именованная сущность. 2 - анафор, часть речи которого является существительным, такие 
  слова как "препарат", или "лекарство". 3- анафор, являющийся местоимением, например "он", "него", "его". 0 - нет кореферентной 
