...
У данного метода, в силу его простоты, много недостатков. Один из самых очевидных - предложения, не содержащие антецедент, относящийся к медецинским препаратам в топике, но связанные с антецедентом, который к ним не относится. Например:
